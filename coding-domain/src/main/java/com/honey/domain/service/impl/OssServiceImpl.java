...
import com.honey.domain.dto.*;
import com.honey.domain.service.OssService;
...
public class OssServiceImpl implements OssService {
    ...
    @Override
    public OssSignResult sign(OssSignParam param) {
        OssSignResult result = new OssSignResult();
